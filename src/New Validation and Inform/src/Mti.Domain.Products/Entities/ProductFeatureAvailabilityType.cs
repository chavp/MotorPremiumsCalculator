...
public sealed class ProductFeatureAvailabilityType : Entity<Guid>
{
    ...
    protected ProductFeatureAvailabilityType(Builder builder) : base(builder.Id)
    {
        Id = builder.Id;
        Code = builder.Code;
    ...
    protected ProductFeatureAvailabilityType() : base()
    {
        Code = default!;
    }
    ...
    public static Builder CreateBuilder(Code code) 
        => new Builder(Guid.NewGuid(), code);
    ...
    public sealed class Builder
    {
        ...
        public ProductFeatureAvailabilityType Build()
        {
            var newEntity = new ProductFeatureAvailabilityType(this);
            return newEntity;
        }
    }
}
