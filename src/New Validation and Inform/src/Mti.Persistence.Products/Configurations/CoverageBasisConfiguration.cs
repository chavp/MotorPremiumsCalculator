...
internal sealed class CoverageBasisConfiguration : IEntityTypeConfiguration<CoverageBasis>
{
    public void Configure(EntityTypeBuilder<CoverageBasis> builder)
    {
        ...
        //        .HasColumnName(nameof(CoverageBasis.Code))
        ...
        builder.OwnsOne(pbi => pbi.Description, descBuilder =>
        {
            ...
            descBuilder.Property(d => d.Value)
                .HasColumnName(nameof(CoverageBasis.Description))
                .HasMaxLength(Description.MaxLength)
                .IsRequired(false);
        });

        builder.HasIndex(nameof(CoverageBasis.Code))
            .HasDatabaseName("IX_CoverageBasises_Code")
            .IsUnique();
    }
}
