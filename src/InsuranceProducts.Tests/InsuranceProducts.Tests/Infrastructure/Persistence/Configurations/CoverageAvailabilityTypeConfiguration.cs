...
internal sealed class CoverageAvailabilityTypeConfiguration : IEntityTypeConfiguration<CoverageAvailabilityType>
{
    public void Configure(EntityTypeBuilder<CoverageAvailabilityType> builder)
    {
        ...
        builder.OwnsOne(cov => cov.Code, codeBuilder =>
        {
            ...
            codeBuilder.Property(code => code.Value)
                .HasColumnName(nameof(CoverageAvailabilityType.Code))
